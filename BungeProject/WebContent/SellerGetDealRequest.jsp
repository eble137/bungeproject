...
<body>
	<div id="consumerDealCt1">
		<div id="consumerDealCt2">
				...
				<div id="consumerDealCt3_2">
					...
					<div id="consumerDealCt3_3">
						<div id="consumerDealCt3_4">
							<span style="font-size: 18px;"><b><%=price%></b></span><span id="deliveryChargeInclude"> <%=deliveryCharge%></span><!-- 가격 -->
							<span>
			...
			<!-- 거래승인 후 주소보내기 -->
<!-- 			<div id="dealDoneAddressSend">
				<button id="gealDoneAddressSendFont">거래승인후 계좌보내기</button>
			</div> -->
		</div>
	</div>
</body>
